...
<section id="navbar" class="blink">
    ...
    <div class="nav_container">
        <ul>
            ...
            <li><a href="<?= $baseUrl ?>/pages/php/about.php">About</a></li>
            <li><a href="<?= $baseUrl ?>/pages/php/resume.php">Resume</a></li>
            <li><a href="<?= $baseUrl ?>/pages/php/services.php">Services</a></li>
            <li><a href="<?= $baseUrl ?>/pages/php/portfolio.php">Portfolio</a></li>
            <li><a href="<?= $baseUrl ?>/pages/php/contact.php">Contact</a></li>
        </ul>
    </div>
